...
public class CountryController {
    ...
    @PostMapping
    public ResponseEntity<CreateCountryResponseDto> add(@RequestBody CreateCountryRequestDto country){
    ...
    @PutMapping
    public ResponseEntity<UpdateCountryResponseDto> getById(@RequestBody UpdateCountryRequestDto country){
